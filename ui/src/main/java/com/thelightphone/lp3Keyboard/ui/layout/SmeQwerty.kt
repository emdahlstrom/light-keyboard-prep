...
private val SmeQwertySwipeConfig: SwipeConfig by lazy {
    object : Lp3KeyboardLayoutCapture("abcdefghijklmnoprstuvyzáčđŋšŧž") {
 ...
 */
@Composable
private fun ColumnScope.SmeThirdRow(
    characters: String,
...
/** The layouts for Northern Sami QWERTY. */
object SmeQwerty {
    object LowerCaseLayout : Layout {
        ...
        override fun ColumnScope.Render(
            ...
            FirstRow("ášertyuiopŋ", callback, swipeConfig, options.enableKeyAnimation)
            SecondRow("asdfghjklđŧ", callback, swipeConfig, options.enableKeyAnimation)
            SmeThirdRow("žzčcvbnm", callback, swipeConfig, options) {
                IconKey(
                    R.drawable.up_lp3,
                    SpecialKey.UpCase,
                    callback,
