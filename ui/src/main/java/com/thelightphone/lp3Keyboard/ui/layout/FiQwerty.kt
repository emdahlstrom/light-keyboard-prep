...
private val FiQwertySwipeConfig: SwipeConfig by lazy {
    object : Lp3KeyboardLayoutCapture("abcdefghijklmnopqrstuvwxyzåäö") {
 ...
 */
@Composable
private fun ColumnScope.FiThirdRow(
    characters: String,
...
object FiQwerty {
    object LowerCaseLayout : Layout {
        ...
        override fun ColumnScope.Render(
            ...
            FiThirdRow("zxcvbnm", callback, swipeConfig, options) {
                IconKey(
                    R.drawable.up_lp3,
                    SpecialKey.UpCase,
                    callback,
