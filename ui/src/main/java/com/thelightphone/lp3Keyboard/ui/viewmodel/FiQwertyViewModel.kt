...
class FiQwertyLp3KeyboardViewModel<SwipeResult>(
    ...
    initialLayout = FiQwerty.LowerCaseLayout,
    lowerCaseLayout = FiQwerty.LowerCaseLayout,
    upperCaseLayout = FiQwerty.UpperCaseLayout,
    capsLockedLayout = FiQwerty.CapsLockedLayout,
)
