...
class SmeQwertyLp3KeyboardViewModel<SwipeResult>(
    ...
    initialLayout = SmeQwerty.LowerCaseLayout,
    lowerCaseLayout = SmeQwerty.LowerCaseLayout,
    upperCaseLayout = SmeQwerty.UpperCaseLayout,
    capsLockedLayout = SmeQwerty.CapsLockedLayout,
)
