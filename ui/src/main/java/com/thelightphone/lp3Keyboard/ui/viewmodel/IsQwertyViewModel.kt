...
class IsQwertyLp3KeyboardViewModel<SwipeResult>(
    ...
    initialLayout = IsQwerty.LowerCaseLayout,
    lowerCaseLayout = IsQwerty.LowerCaseLayout,
    upperCaseLayout = IsQwerty.UpperCaseLayout,
    capsLockedLayout = IsQwerty.CapsLockedLayout,
)
